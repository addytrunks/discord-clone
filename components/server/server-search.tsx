...
const ServerSearch = ({data}:ServerSearchProps) => {
  ...
  return (
    <>
        <button onClick={() => setOpen(true)} className="group px-2 rounded-md flex items-center gap-x-2 w-full hover:bg-zinc-700/10 dark:bg-[#272A3E] dark:bg-opacity-50 transition py-2 hover:dark:bg-opacity-70">
